...
void CClydeEEPROM::reset() {
  ...
  uint32_t sunsetIntervals[sunsetSteps] = {30000, 30000, 40000, 60000, 60000, 60000, 60000, 60000, 60000}; //real
  //uint32_t sunsetIntervals[sunsetSteps] = {500, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000}; //demo
