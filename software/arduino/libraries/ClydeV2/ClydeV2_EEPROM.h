...
/*
  ...
  10:     REMOVED # of sunset steps (e.g. 6)
  11-46:  REMOVED sunset colors (e.g. R,G,B,R,G,B... max = 12)
  47-94:  REMOVED 32-bit sunset color intervals (e.g. millis, millis... max = 12)
*/
